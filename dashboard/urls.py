...
urlpatterns = [
    ...
    path('leaves/cancel/<int:id>/',views.cansel_leave_emp,name='canselleaveapprove_emp'),
    path('leaves/uncancel/<int:id>/',views.create_leave_emp,name='createleaveapprove_emp'),
    path('leaves/all/view/<int:id>/',views.leaves_view,name='userleaveview2'),

    # ###path('leave/unapprove/<int:id>/',views.unapprove_leave2,name='userleaveunapprove2'),
    path('leave/unapprove2/<int:id>/',views.unapprove_leave2,name='userleaveunapprove2'),
    ...
    path("dashboard/",views.you,name='you'),
