...
class Leave(models.Model):
	...
	startdate = models.DateField(verbose_name=_('開始日'),help_text='leave start date is on ..',null=True,blank=False)
	enddate = models.DateField(verbose_name=_('終了日'),help_text='coming back on ...',null=True,blank=False)
	leavetype = models.CharField(verbose_name=_('理由'),choices=LEAVE_TYPE,max_length=25,default=SICK,null=True,blank=False)
	...
	status = models.CharField(max_length=12,default='申請中') #pending,approved,rejected,cancelled
